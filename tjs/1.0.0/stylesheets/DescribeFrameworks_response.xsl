			...
			<body>
				...
				<xsl:for-each select="tjs:FrameworkDescriptions/tjs:Framework">
					...
					<table border="1" cellpadding="3">
						...
						<tr><td colspan="2" align="center"><xsl:element name="a"><xsl:attribute name="href"><xsl:value-of select="tjs:DescribeDatasetsRequest/@xlink:href"/>&amp;XSL=<xsl:value-of select="$XSLroot"/>DescribeDatasets_response.xsl</xsl:attribute>Datasets</xsl:element></td></tr>
					</table>
				</xsl:for-each>
				</center>
			</body>
