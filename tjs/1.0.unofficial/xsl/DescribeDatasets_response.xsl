						...
						<tr><td align="right" valign="top"><i>Datasets:</i></td><td>
							<xsl:for-each select="tjs:Dataset">
								<table border="1" cellpadding="3" width="100%">
									...
									<tr><td align="right" width="180"><i>DatasetKey:</i></td><td><xsl:value-of select="tjs:DatasetKey" /></td></tr>
									...
									<tr><td colspan="2" align="center"><xsl:element name="a"><xsl:attribute name="href"><xsl:value-of select="$Service"/>Service=TJS&amp;AcceptVersions=<xsl:value-of select="/tjs:DatasetDescriptions/@version" />&amp;Request=DescribeData&amp;FrameworkURI=<xsl:value-of select="/tjs:DatasetDescriptions/tjs:Framework/tjs:FrameworkURI" />&amp;DatasetURI=<xsl:value-of select="tjs:DatasetURI" />&amp;XSL=<xsl:value-of select="$XSLroot"/>/DescribeData_response.xsl</xsl:attribute>Attributes</xsl:element></td></tr>
								</table>
								<p/>
							</xsl:for-each>
						</td></tr>
