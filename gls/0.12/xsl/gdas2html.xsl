...
<table border="1">
	<xsl:for-each select="gls:GDAS/gls:Framework/gls:Dataset">
		<tr>
			<th><a href="#dataset"><xsl:value-of select="gls:DatasetKey" /></a></th>
			<xsl:for-each select="gls:Attribute">
				<xsl:if test="gls:AttributeName != ../gls:DatasetKey">
	...
	<xsl:for-each select="gls:GDAS/gls:Framework/gls:Dataset/gls:Rowset/gls:Row">
		<tr>
			<td bgcolor="#ffcc33"><xsl:value-of select="gls:K" /></td>
...
<h3 id="framework">Framework Description</h3>
   <table border="1" cellpadding="3">
    ...
    <tr><td align="right"><i>Abstract:</i></td><td><xsl:value-of select="gls:GDAS/gls:Framework/gls:Abstract" /></td></tr>
    ...
    <tr><td align="right"><i>Framework Key:</i></td><td bgcolor="#ffcc33"><xsl:value-of select="gls:GDAS/gls:Framework/gls:FrameworkKey" /></td></tr>
   </table>
   <hr/>
   <p/>
   ...
   <table border="1" cellpadding="3">
    ...
    <tr><td align="right"><i>Abstract:</i></td><td><xsl:value-of select="gls:GDAS/gls:Framework/gls:Dataset/gls:Abstract" /></td></tr>
    <tr><td align="right"><i>Documentation:</i></td><td>
     <xsl:element name="a">
      <xsl:attribute name="href">
    ...
    <tr><td align="right" width="180"><i>DatasetKey:</i></td><td bgcolor="#ffcc33"><xsl:value-of select="gls:GDAS/gls:Framework/gls:Dataset/gls:DatasetKey" /></td></tr>
    <tr><td align="right"><i>Dataset Key Type:</i></td><td><xsl:value-of select="gls:GDAS/gls:Framework/gls:Dataset/gls:DatasetKey/@type" /></td></tr>
    <tr><td align="right"><i>Dataset Key Length:</i></td><td><xsl:value-of select="gls:GDAS/gls:Framework/gls:Dataset/gls:DatasetKey/@length" /></td></tr>
    <tr><td align="right"><i>Records per Identifier:</i></td><td><xsl:value-of select="gls:GDAS/gls:Framework/gls:Dataset/gls:KeyRelationship" /></td></tr>
    <tr><td align="right"><i>Complete linkage:</i></td><td><xsl:value-of select="gls:GDAS/gls:Framework/gls:Dataset/gls:KeyComplete" /></td></tr>
   </table>
   <p/>
   <hr/>
