...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gls="http://www.opengis.net/gls/0.12" xpath-default-namespace="http://www.opengis.net/gls/0.12" xmlns:ows="http://www.opengis.net/ows/1.1" xmlns:xlink="http://www.w3.org/1999/xlink">
   ...
   <table border="1" cellpadding="3">
	<xsl:for-each select="gls:Attribute">
			...
			<xsl:when test="gls:Values/gls:Nominal">
				...
				<table width="100%" border="1" cellpadding="3">
					<tr bgcolor="#cccccc">
						...
						<td>
							<table cellpadding="3">
								<tr><td align="right"><i>Valueset Title:</i></td><td><xsl:value-of select="gls:Values/gls:Nominal/gls:Classes/gls:Title"/></td></tr>
								<tr><td align="right" valign="top"><i>Abstract:</i></td><td><xsl:value-of select="gls:Values/gls:Nominal/gls:Classes/gls:Abstract"/></td></tr>
								<tr><td align="right"><i>Documentation:</i></td><td><xsl:element name="a"><xsl:attribute name="href"><xsl:value-of select="gls:Values/gls:Nominal/gls:Classes/gls:Documentation" /></xsl:attribute><xsl:value-of select="gls:Values/gls:Nominal/gls:Classes/gls:Documentation" /></xsl:element></td></tr>
							</table>
						</td>
					</tr>
			...
			<xsl:when test="gls:Values/gls:Ordinal">
				...
				<table width="100%" border="1" cellpadding="3">
					<tr bgcolor="#cccccc">
						...
						<td>
							<table cellpadding="3">
								<tr><td align="right"><i>Valueset Title:</i></td><td><xsl:value-of select="gls:Values/gls:Ordinal/gls:Classes/gls:Title"/></td></tr>
								<tr><td align="right" valign="top"><i>Abstract:</i></td><td><xsl:value-of select="gls:Values/gls:Ordinal/gls:Classes/gls:Abstract"/></td></tr>
								<tr><td align="right"><i>Documentation:</i></td><td><xsl:element name="a"><xsl:attribute name="href"><xsl:value-of select="gls:Values/gls:Ordinal/gls:Classes/gls:Documentation" /></xsl:attribute><xsl:value-of select="gls:Values/gls:Ordinal/gls:Classes/gls:Documentation" /></xsl:element></td></tr>
							</table>
						</td>
					</tr>
		...
		<tr><td colspan="3" align="center"><xsl:element name="a"><xsl:attribute name="href"><xsl:value-of select="$Service"/>Service=GLS&amp;Version=<xsl:value-of select="/gls:DataDescriptions/@version" />&amp;Request=GetData&amp;FrameworkURI=<xsl:value-of select="/gls:DataDescriptions/gls:Framework/gls:FrameworkURI" />&amp;DatasetURI=<xsl:value-of select="/gls:DataDescriptions/gls:Framework/gls:Dataset/gls:DatasetURI" />&amp;Attributes=<xsl:value-of select="gls:AttributeName" />&amp;XSL=<xsl:value-of select="$XSLroot"/>/gdas2html.xsl</xsl:attribute>View data</xsl:element></td></tr>
    	</xsl:for-each>
   </table>
									</td></tr>
								</table>
