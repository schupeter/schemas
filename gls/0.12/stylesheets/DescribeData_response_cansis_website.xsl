...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gls="http://www.opengis.net/gls/0.12" xpath-default-namespace="http://www.opengis.net/gls/0.12" xmlns:ows="http://www.opengis.net/ows/1.1" xmlns:xlink="http://www.w3.org/1999/xlink">
  <xsl:template match="/">
    <xsl:variable name="Service">http://localhost/mapit/serv?</xsl:variable>
    <xsl:variable name="XSLroot">http://localhost/stylesheets/gls/0.12</xsl:variable>
              ...
              <tr>
                ...
                <td ><strong>Description</strong></td>
                    ...
                    <xsl:for-each select="gls:Attribute">
                      <tr>
                        <th align="left"><xsl:element name="a"><xsl:attribute name="href"><xsl:value-of select="gls:Documentation" /></xsl:attribute><xsl:value-of select="gls:AttributeName" /></xsl:element></th>
