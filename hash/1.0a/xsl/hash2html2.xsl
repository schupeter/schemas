...
<table border="1">
	<xsl:for-each select="/Hash">
		<xsl:choose>
			<xsl:when test="Table">
				<tr>
					<xsl:for-each select="/Hash/KeyDescriptions/Column">
						<th bgcolor="#cc9933">Key:<br/><xsl:element name="a"><xsl:attribute name="href">#<xsl:value-of select="@name" /></xsl:attribute><xsl:value-of select="@name" /></xsl:element></th>
					</xsl:for-each>
					<th bgcolor="#9acd32">Value:<br/><a href="#Value"><xsl:value-of select="/Hash/ValueDescription/Column/@name" /></a></th>
				</tr>
				<xsl:for-each select="/Hash/Table/Pair">
					<tr>
						<td bgcolor="#ffcc33"><xsl:value-of select="@key" /></td>
	...
	<xsl:for-each select="/Hash/KeyDescriptions/Column">
		<xsl:choose>
			<xsl:when test="Values/Nominal">
				<tr bgcolor="#cc9933"><th colspan="2"><xsl:element name="a"><xsl:attribute name="name"><xsl:value-of select="name" /></xsl:attribute></xsl:element><xsl:value-of select="name" /></th></tr>
				<tr><td align="right"><i>Title:</i></td><td><b><xsl:value-of select="Title" /></b></td></tr>
				...
				<table width="100%" border="1" cellpadding="3">
					...
					<xsl:for-each select="Values/Nominal/Classes/Value">
						<tr>
							<td align="center" bgcolor="#ffcc33"><b><xsl:value-of select="Identifier"/></b></td>
							<td>
								<table cellpadding="3">
									<tr><td align="right"><i>Title:</i></td><td><b><xsl:value-of select="Title"/></b></td></tr>
					...
					<xsl:for-each select="Values/Nominal/Exceptions/Value">
						<tr>
							<td align="center" bgcolor="#ffcc33"><b><xsl:value-of select="Identifier"/></b></td>
							<td align="center" bgcolor="#9966cc"></td>
							<td>
								<table cellpadding="3">
									<tr><td align="right"><i>Title:</i></td><td><b><xsl:value-of select="Title"/></b></td></tr>
									<tr><td align="right" valign="top"><i>Abstract:</i></td><td><xsl:value-of select="Abstract"/></td></tr>
			...
			<xsl:when test="Values/Ordinal">
				...
				<table width="100%" border="1" cellpadding="3">
					...
					<xsl:for-each select="Values/Ordinal/Classes/Value">
						<tr>
							<td align="center" bgcolor="#ffcc33"><b><xsl:value-of select="Identifier"/></b></td>
							<xsl:element name="td"><xsl:attribute name="align">center</xsl:attribute><xsl:attribute name="bgcolor"><xsl:value-of select="@color" /></xsl:attribute><xsl:value-of select="@rank"/></xsl:element>
							<td>
								<table cellpadding="3">
									<tr><td align="right"><i>Title:</i></td><td><b><xsl:value-of select="Title"/></b></td></tr>
									<tr><td align="right" valign="top"><i>Abstract:</i></td><td><xsl:value-of select="Abstract"/></td></tr>
					...
					<xsl:for-each select="Values/Ordinal/Exceptions/Value">
						<tr>
							<td align="center" bgcolor="#ffcc33"><b><xsl:value-of select="Identifier"/></b></td>
							<xsl:element name="td"><xsl:attribute name="align">center</xsl:attribute><xsl:attribute name="bgcolor"><xsl:value-of select="@color" /></xsl:attribute><xsl:value-of select="@rank"/></xsl:element>
							<td>
...
The resultant value has the following characteristics:
	<table border="1" cellpadding="3">
	<xsl:for-each select="/Hash/ValueDescription/Column">
		<xsl:choose>
			<xsl:when test="Values/Nominal">
				...
				<table width="100%" border="1" cellpadding="3">
					...
					<xsl:for-each select="Values/Nominal/Classes/Value">
						<tr>
							<td align="center" bgcolor="#99ff99"><b><xsl:value-of select="Identifier"/></b></td>
							<xsl:element name="td"><xsl:attribute name="align">center</xsl:attribute><xsl:attribute name="bgcolor"><xsl:value-of select="@color" /></xsl:attribute></xsl:element>
							<td>
								<table cellpadding="3">
									<tr><td align="right"><i>Title:</i></td><td><b><xsl:value-of select="Title"/></b></td></tr>
									<tr><td align="right" valign="top"><i>Abstract:</i></td><td><xsl:value-of select="Abstract"/></td></tr>
